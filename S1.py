...
df_si['age_group'] = df_si['Age'].apply(categorize_age_group)
...
df_si['age_group_detail'] = df_si['Age'].apply(categorize_age_group_detail)
...
#all_option= df_tsp_sort["Tsp"].unique()
#tsp_list= [all_option]+list(df_tsp_sort["Tsp"].unique())
...
if df_si.empty:
    ...
    colors= {'Dropout':'black','Successful_Referral':'red'}
